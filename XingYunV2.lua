...
print("用户界面库加载成功！")
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("星云脚本")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
local CNA = CNScript:section("云制作", false)
local CNS = CNScript:section("其他国外脚本", false)
local CN = CNScript:section("联动脚本🎉", false)
...
LOL:Label("星云脚本的创作者云 QQ3369370682")
LOL:Button(
    "QQ群",
    function()
...
print("[星 云脚本 ]: 星云脚本 THIEF LIFE SIMULATOR LOADING...")
...
Game:addToggle("RTX着色器", false, function(rtxshaders)
    ...
    if rtxshaders == false then
        for i,v in pairs(game.Lighting:GetChildren()) do
            if v.Name == "[ 星云脚本 ]: 日落" then
                v:Destroy()
            elseif v.Name == "[ 星云脚本 ]: 花" then
                v:Destroy()
            elseif v.Name == "[ 云脚本 ]: 伊那里泰莎" then
                v:Destroy()
            elseif v.Name == "[ 星云脚本 ]: 简单" then
                v:Destroy()
            elseif v.Name == "[ 星云脚本 ]: 阳光" then
                v:Destroy()
            elseif v.Name == "[ 星云脚本 ]: 高山" then
                v:Destroy()
            end
        end
        wait()
    ...
    while killpetloop do
        if playertarget == "All" then
            ...
            if game.workspace.Pets:FindFirstChild(playertarget .."_PET") ~= nil then
                ...
                Notification:Notify(
                    {Title = "星云脚本", Description = "玩家没有装备宠物"},
                    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "default"}
                )
                killpetloop = false
            end
